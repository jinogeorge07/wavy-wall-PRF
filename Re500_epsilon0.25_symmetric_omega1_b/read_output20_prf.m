...
% quiver = "OFF";
kz_idx = 20;
load('stability_results_Re500_kz20_148x108.mat');   % expects x,y,U_hat,V_hat,W_hat,kz_list,c_list,omega
...
% make subfolder
snapdir = fullfile(folderpath, sprintf('snapshots_wavywall_kz%0.4g', kz));
...
if show_velocity == "true"
    ...
    for i = [7,9,12]
        ...
        %levels = linspace(-Umax_common, Umax_common, 39);
        ...
        %contourf(x, y, U_plot, levels, 'LineWidth', 0.5);
        hold on
        ...
        %levels = linspace(-Vmax_common, Vmax_common, 39);
        ...
        %contourf(x, y, V_plot, levels, 'LineWidth', 0.5);
        set(gcf,'Renderer','painters');
        set(gca,'Color','white');
        shading flat
        ...
        %levels = linspace(-Wmax_common, Wmax_common, 39);
        fW1 = figure('Visible','on','Position',[100 100 1000 800]);
        ...
        %contourf(x, y, W_plot, levels, 'LineWidth', 0.5);
        set(gcf,'Renderer','painters');
        set(gca,'Color','white');
        shading flat
