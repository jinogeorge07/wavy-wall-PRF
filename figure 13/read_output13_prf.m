...
for kz_idx = [5,20,32]
    ...
    for i = [1]
        ...
        writematrix(U2_plot, fullfile(sprintf('U_response_c%02d_kz%g.csv', i, kz)));
        % fill solid patch
        ...
        daspect([1 1 1]);
        exportgraphics(fU3, sprintf('U_response_c%02d_kz%g.png', i, kz), ...
        ...
        writematrix(V2_plot, fullfile(sprintf('V_response_c%02d_kz%g.csv', i, kz)));
        % fill solid patch
        fill_patch_wavywall(x_wall, y1_wall, y2_wall);
        plot(x_wall, y1_wall, 'k', 'LineWidth', 2);
        plot(x_wall, y2_wall, 'k', 'LineWidth', 2);
        ...
        daspect([1 1 1]);
        exportgraphics(fV3, sprintf('V_response_c%02d_kz%g.png', i, kz), ...
        'Resolution', 200, 'BackgroundColor', 'white');
        close(fV3);
        ...
        %% ---------- W: contour response mode ----------
            ...
            writematrix(W2_plot, fullfile(sprintf('W_response_c%02d_kz%g.csv', i, kz)));
            % fill solid patch
            fill_patch_wavywall(x_wall, y1_wall, y2_wall);
            plot(x_wall, y1_wall, 'k', 'LineWidth', 2);
            plot(x_wall, y2_wall, 'k', 'LineWidth', 2);
            ...
            daspect([1 1 1]);
            exportgraphics(fW3, sprintf('W_response_c%02d_kz%g.png', i, kz), ...
            'Resolution', 200, 'BackgroundColor', 'white');
